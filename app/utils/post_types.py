...
POST_TYPES = {
    "useful": {
        ...
        "cta": "💡 Хотите настроить такую же интеграцию? → @smart_analytics_mp_bot",
        "prompt_addition": """
...
"""
    ...
    "case": {
        ...
        "cta": "📊 Рассчитать вашу экономию можно в боте → @smart_analytics_mp_bot",
        "prompt_addition": """
...
"""
    ...
    "interactive": {
        ...
        "frequency": 1,  # 1 раз в цикле
        "cta": "💬 Поделитесь вашим опытом в боте → @smart_analytics_mp_bot",
        "prompt_addition": """
